...
// ref: https://stackoverflow.com/questions/70754397/how-to-implement-bounce-effect-on-jetpack-compose-lazy-column
@OptIn(ExperimentalFoundationApi::class)
class VerticalOverscroll(val scope: CoroutineScope, private val resistance: Float = 0.2f) :
    OverscrollEffect {
    ...
    private var overscrollY by mutableStateOf(Animatable(0f))
